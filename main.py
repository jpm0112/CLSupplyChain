...
#todo watch out when defining a value to one. The saving fucntion of the csv file may save a list rather than than matrix
supplier_number = 20
plants_number = 20
retailers_number = 10
...
parts_list = list(range(parts_number))
...
parts_of_architecture = np.loadtxt('parts_of_architecture.csv', delimiter=',')
...
designs_of_parts = np.loadtxt('designs_of_parts.csv', delimiter=',')
